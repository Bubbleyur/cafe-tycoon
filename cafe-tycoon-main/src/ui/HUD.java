...
public class HUD {
    ...
    private static final long SHIFT_DURATION_MS = 300000; // 5 minutes in milliseconds
    ...
    public boolean isShiftExpired() {
        ...
        return System.currentTimeMillis() - shiftStartTime >= SHIFT_DURATION_MS;
    }
    ...
    private void drawShiftTimer(Graphics2D g2, int x, int y, GameEngine engine) {
        ...
        long remainingMs = SHIFT_DURATION_MS - elapsedMs;
