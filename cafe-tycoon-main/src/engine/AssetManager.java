...
public class AssetManager {
    ...
    public static BufferedImage iconNeutral;
    public static BufferedImage iconSad;
    public static BufferedImage cup1Sprite;
    public static BufferedImage trashbinSprite;
    ...
    private static boolean tryLoadPreCroppedSprites() {
        try {
            ...
            iconNeutral = loadPng(SPRITES_PATH + "icon_neutral.png");
            iconSad = loadPng(SPRITES_PATH + "icon_sad.png");
            cup1Sprite = loadPng(SPRITES_PATH + "Cup1.png");
            trashbinSprite = loadPng(SPRITES_PATH + "trashbin.png");
        ...
        try {
            ...
            for (AssetDefinition def : AssetRegistry.UI_ICONS) {
                ...
                if ("icon_happy".equals(def.name)) {
                    ...
                    iconSad = icon;
                } else if ("icon_neutral".equals(def.name)) {
                    iconNeutral = icon;
                }
            }
    ...
    private static void generateProceduralFallbacks() {
        ...
        trashbinSprite = generateProceduralAsset(AssetType.TRASHBIN, 0, false);
    ...
    private enum AssetType {
        PLAYER, TABLE, COFFEE_MACHINE, MILK_DISPENSER, TOPPING_STATION, STOCK_STATION, CASHIER_COUNTER, TRASHBIN
    }
    ...
    private static BufferedImage generateProceduralAsset(AssetType type, int direction, boolean bobbed) {
        ...
        switch (type) {
            ...
            case TABLE:
                ...
                g2.fillOval(12, 10, 40, 40);
                g2.setColor(new Color(222, 184, 135));
                g2.setStroke(new BasicStroke(1.5f));
                g2.drawOval(12, 10, 40, 40);
                break;

            case COFFEE_MACHINE:
                g2.setColor(new Color(0, 0, 0, 60));
                g2.fillOval(4, 52, 56, 56);
            ...
            case STOCK_STATION:
                ...
                g2.fillOval(14, 30, 16, 16);
                g2.fillOval(26, 31, 14, 14);
                break;
            ...
            case TRASHBIN:
                g2.setColor(new Color(0, 0, 0, 50));
                g2.fillOval(8, 50, 48, 48);
                
                g2.setColor(new Color(117, 117, 117)); // Dark grey bin body
                g2.fillRoundRect(16, 20, 32, 36, 4, 4);
                
                g2.setColor(new Color(189, 189, 189)); // Light grey ridges/stripes
                for (int i = 22; i <= 42; i += 6) {
                    g2.fillRect(i, 24, 2, 28);
                }
                
                g2.setColor(new Color(97, 97, 97)); // Bin lid
                g2.fillRoundRect(12, 14, 40, 8, 4, 4);
                g2.fillRect(24, 8, 16, 6); // Handle
                break;
        }
