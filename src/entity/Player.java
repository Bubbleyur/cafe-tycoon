...
public class Player {
    ...
    public String translateItemOnHand(String itemOnHand) {
        if (itemOnHand == null || itemOnHand.equalsIgnoreCase("None")) return "Kosong";
        String translated = logic.DrinkRecipe.terjemahkanRacikan(itemOnHand);
        if (translated.equals("Gagal")) {
            return itemOnHand;
        }
        return translated;
    }
